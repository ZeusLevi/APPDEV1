...
export class BerriesService {
  getBerries() {
    return[
      ...
      {name: 'Miracle Berry', held: "If the holder has a non-volatile status condition or confusion, it will consume its held MiracleBerry and be cured of it.", bag: "When used from the Bag on a Pokémon, it cures that Pokémon of all non-volatile status conditions and confusion. This consumes the MiracleBerry."},
      {name: 'Mystery Berry', held: "If one of the holder's moves runs out of PP, it consumes its held MysteryBerry and 5 PP is restored to that move.", bag: "When used from the Bag on a Pokémon, it restores 5 PP to one of that Pokémon's moves. This consumes the MysteryBerry."},
      {name: 'PRZ Cure Berry', held: "If the holder is paralyzed, it will consume its held PRZCureBerry and cure itself of paralysis.", bag: "When used from the Bag on a Pokémon, it cures that Pokémon of paralysis. This consumes the PRZCureBerry."},
      {name: 'PSN Cure Berry', held: "If the holder is poisoned, it will consume its held PSNCureBerry and cure it of poison.", bag: "When used from the Bag on a Pokémon, it cures that Pokémon of poison. This consumes the PSNCureBerry."},
